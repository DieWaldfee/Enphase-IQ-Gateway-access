...
let envoy_password = '57!)!2.w.HG;Gdj'; // Add your Enphase Enlighten Cloud password (mandatory)
...
// -------------------------------------------------------------------------------------------------------------------
// basic funktion: renewEnvoyToken
// -------------------------------------------------------------------------------------------------------------------
...
const cyclicSchedule = schedule(pollingCron, async () => {
   try {
      if (error_cnt <= 0) {
         ...
         if (getState(dpPrefix + 'livedata.connection.sc_stream').val == 'disabled') {
